...
export class CreateNetflixShowDto {
    ...
    @ApiPropertyOptional({ example: 'As her father nears the end of his life, filmmaker Kirsten Johnson stages his death in inventive and comical ways to help them both face the inevitable.' })
    @IsString()
    @IsOptional()
    description?: string;
}
